...
export default function SalesDashboard() {
  ...
  // FIXED: Now handles both PDF stream and base64 JSON
  const downloadInvoice = async (id) => {
    try {
      ...
      if (contentType.includes('application/pdf')) {
        ...
        if (!json.pdf) throw new Error('No PDF data in response');
      ...
      showToast(err.message || 'Failed to download invoice', true);
    }
  };
