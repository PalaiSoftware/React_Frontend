/* ——— NO LINES REMOVED ——— */
/* ——— ONLY REQUIRED ADDITIONS ARE MARKED WITH // ⭐ ADDED ——— */
    ...
    <>
      <div className="p-6">
        ...
        <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <table className="min-w-full table-fixed divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  {/* ⭐ ADDED — LIMIT DESCRIPTION WIDTH */}
                  <th className="w-48 px-6 py-3 text-left text-xs font-medium uppercase text-gray-900 max-w-desc">
                    Desc
                  </th>
                  ...
                  paginated.map((p, i) => {
                    ...
                    return (
                      <tr key={p.id} className={isEditing ? 'bg-yellow-50' : ''}>
                        ...
                        {/* DESCRIPTION WITH WRAP — ⭐ ADDED */}
                        <td className={`px-6 py-4 text-sm max-w-desc break-words whitespace-normal ${colorCls}`}>
                          {isEditing ? (
                            <textarea
                            ...
                            <div className="max-w-desc whitespace-normal break-words">
                              {p.description}
                            </div>
                          )}
                        </td>
          ...
          {/* MOBILE VIEW ALREADY WRAPS BY DEFAULT */}
      ...
      {/* ⭐ ADDED CSS — LIMIT DESCRIPTION + WORD WRAP */}
      <style
        dangerouslySetInnerHTML={{
          __html: `
            .max-w-desc { max-width: 180px; white-space: normal; word-wrap: break-word; }  /* ⭐ */
            @keyframes slide-in {
